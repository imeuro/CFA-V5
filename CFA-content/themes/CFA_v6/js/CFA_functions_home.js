...
let getADS = () => {
	...
	sp1.setAttribute('class','post type-post has-post-thumbnail hentry status-publish format-sp1 post-spinsert');
	sp1.setAttribute('id', 'spblock1');
	let sp2 = adslot1;
	...
	sp1_2.setAttribute('class','post type-post has-post-thumbnail hentry status-publish format-sp2 post-spinsert');
	sp1_2.setAttribute('id', 'spblock2');
	let sp2_2 = adslot2;
	...
	sp1_3.setAttribute('class','post type-post has-post-thumbnail hentry status-publish format-sp3 post-spinsert');
	sp1_3.setAttribute('id', 'spblock3');
	let sp2_3 = adslot3;
	...
	sp1_4.setAttribute('class','post type-post has-post-thumbnail hentry status-publish format-sp4 post-spinsert');
	sp1_4.setAttribute('id', 'spblock4');
	let sp2_4 = adslot4;
