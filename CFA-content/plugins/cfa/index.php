...
function get_langswitcherDOM() {
	...
	if ( is_home() || is_front_page() || is_page('it') ) {
		$ldom .= '<li><a href="'.home_url('/').'" data-lang="EN">ENG</a>';
		$ldom .= '<a href="'.home_url('/it/').'" data-lang="IT">ITA</a></li>';
		...
		if ( 'cfa_translations' == get_post_type() || $post->post_parent == '95535' ) :
			...
			$ldom .= '<li><a href="'.$translationURL.'" data-lang="EN">ENG</a>';
			$ldom .= '<span data-lang="IT">ITA</span></li>';
		else : 
			if ($translationID == null) { $translationURL = home_url('/it/'); } // No translation ->link to home ITA
			$ldom .= '<li><span data-lang="EN">ENG</span>';
			$ldom .= '<a href="'.$translationURL.'" data-lang="IT">ITA</a></li>';
		endif;
	}
	return $ldom;
}
