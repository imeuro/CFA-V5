...
class SH_Pinterest extends SH_Social_Service {
	...
	public function shareButton($url, $title = '', $showCount = false) {
		...
		//$html .= "<a title=\"" . $linkTitle . "\" class=\"" . $this->cssClass() . "\" href='https://www.pinterest.com/pin/create/button/' data-pin-do=\"buttonBookmark\" data-pin-custom=\"true\" data-pin-url=\"$url\">";


		$html .= "<a data-pin-url=\"$url\" data-pin-do=\"buttonBookmark\" data-pin-custom=\"true\" href=\"https://www.pinterest.com/pin/create/button/\">";
