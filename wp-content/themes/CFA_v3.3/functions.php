...
function pinbin_scripts() {
	...
	$cacheBusterJS = date("mdHi", filemtime( get_stylesheet_directory()  . '/js/functions.js'));
	//echo 'TEST $cacheBusterJS: '.$cacheBusterJS.' | '.get_template_directory_uri() . '/js/functions.js';
	...
	wp_enqueue_script( 'pinbin.functions', get_template_directory_uri() . '/js/functions.js', array( 'imagesloaded' ), $cacheBusterJS, true );
...
function CFA_gallery_shortcode($attr) {
	...
	<div class='CFAslider' id='CFAslider'>\n
	<ul id='$selector' class='gallery slider galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class}'>\n\n";
	...
	if($frecce=='ok') :
		$output .= "<div class = 'prevContainer'>\n
				<div class = 'prev'><span>&larr;</span></div>\n
			</div>\n\n

			<div class = 'nextContainer'>\n
				<div class = 'next'><span>&rarr;</span></div>\n
			</div>\n
			<div class = 'selectorsBlock'><div class = 'indicators'>\n";
